...
exports.writeSchemas = function() {
    ...
    var settingsReadme = path.resolve(dir, './settings.md');
    ...
    log('[i] Writing ' + settingsReadme);
    fs.outputFileSync(settingsReadme, settingsFileContent);
    files[settingsReadme] = settingsFileContent;
