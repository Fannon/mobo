...
exports.writeSchemas = function() {
    ...
    for (var i = 0; i < schemaExports.length; i++) {
        ...
        fileContent += '> Read the latest version [online at GitHub](https://github.com/Fannon/mobo/blob/master/examples/init/' + schemaName + '/SCHEMA.md)\n\n';
        fileContent += '> Refer to the corresponding [README.md](https://github.com/Fannon/mobo/blob/master/examples/init/' + schemaName + '/README.md) for a more verbose documentation.\n\n';
    ...
    fileContent += ' > Read the latest version [online at GitHub](https://github.com/Fannon/mobo/blob/master/examples/init/settings.md). \n\n';
