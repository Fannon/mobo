...
exports.convertSchemaToTable = function(schema) {
    ...
    if (schema.properties) {
        ...
        //    html += '<div class="description">' + schema.description + '</div>\n';
        //}
        ...
        html += '   <thead>\n';
        html += '       <tr>\n';
        html += '           <th><small>ID</small></th>\n';
        html += '           <th><small>Type</small></th>\n';
        html += '           <th><small>Default</small></th>\n';
        html += '           <th><small>Description</small></th>\n';
        html += '       </tr>\n';
        html += '   </thead>\n';
        html += '   <tbody>\n';
        ...
        for (var propertyName in schema.properties) {
            ...
            html += '       <tr>\n';
            html += '           <td><small>' + propertyName + '</small></td>\n';
            html += '           <td><small>' + type + '</small></td>\n';
            html += '           <td><small>' + defaultValue + '</small></td>\n';
