...
handlebars.registerHelper('smw_templ_attr', function(attr) {
    ...
    if (attr.smw_arraymap) {
        ...
        if (contentType === 'page') {
            result = '{{#arraymap:{{{' + attributeName + '|}}}|;|@@@@|[[' + finalPropertyArrayMap + '{{!}}@@@@]]|,&nbsp;}}';
            ...
            //result = '{{#arraymap:{{{' + attributeName + '|}}}|;|@@@@|[[' + finalPropertyArrayMap + '{{!}}@@@@]]|,&nbsp;}}';
            result = '{{#arraymap:{{{' + attributeName + '|}}}|;|@@@@|{{#formredlink:target=' + finalPropertyArrayMap + '|form=' + targetForm + alternativeForms + '|link text=@@@@ }}|,&nbsp;}}';
        } else {
            result = '{{#arraymap:{{{' + attributeName + '|}}}|;|@@@@|' + finalPropertyArrayMap + '|,&nbsp;}}';
        }
