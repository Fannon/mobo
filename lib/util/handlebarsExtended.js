...
handlebars.registerHelper('smw_formtable', function(model) {
    ...
    if (model && model.properties) {
        ...
        for (var attrName in attrCollection) {
            ...
            if (attr.sf_form) {
                for (var paramName in attr.sf_form) {
                    paramObj[paramName] = attr.sf_form[paramName];
                }
            }
            ...
            if (attr.smw_appendFormField) {
                sfFieldFunction += attr.smw_appendFormField;
            }
