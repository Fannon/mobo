...
exports.exec = function(settings, jobs) {
    ...
    if (jobs.indexOf('structure') > -1) {
        ...
        exports.nukeNamespaces[10] = 'MW Templates [10]';
        exports.nukeNamespaces[14] = 'MW Categories [14]';
        exports.nukeNamespaces[102] = 'SMW Properties [102]';
        exports.nukeNamespaces[106] = 'SF Forms [106]';
        exports.nukeNamespaces[108] = 'SMW Concepts [108]';
    }
...
exports.deletePage = function(err, response) {
    ...
    if (err) {
        ...
        log('[-] (' +  semlog.pad(exports.counter, 5) + ') ' + response.title);
    }
};
