...
exports.exec = function(settings, dirName) {
    ...
    var readPromise = readProject.read(path.join(settings.cwd, '/import/' + dirName), dirName).then(function(contents) {
        ...
        if (exports.fileMap['import.js']) {
            ...
            var importedPages = exports.programmaticImport(exports.fileMap);
 ...
 * @param {{}} fileMap
 */
exports.programmaticImport = function(fileMap) {
