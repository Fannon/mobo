...
exports.exec = function(customSettings) {
    ...
    settings.templateDir = path.join(cwd, '/mobo_template/');
    settings.logDir = path.join(cwd, '/_logfiles/');
    settings.processedModelDir = path.join(cwd, '/_processed/');
    ...
    if (fs.existsSync(settings.processedModelDir) && !fs.existsSync(settings.templateDir)) {
        ...
        settings.templateDir = path.join(cwd, '/templates/');
    }
