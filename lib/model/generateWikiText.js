...
module.exports = function(settings, registry) {
    ...
    // Get Fields
    callParser(settings, parseField, registry.field, registry, generated);

    // Get Models
    callParser(settings, parseModel, registry.deep, registry, generated);

    // Get Forms
    callParser(settings, parseForm, registry.deepForm, registry, generated);
    ...
    callParser(settings, parseQuery, registry.smw_query, registry, generated);
 ...
 * @param generated
 */
callParser = function(settings, generator, data, registry, generated) {
            ...
            for (var outputType in output) {
                ...
                for (var pageName in output[outputType]) {
                    ...
                    if (generated[fileName]) {
                        log('> [INFO] Wiki page ' + fileName + ' is going to be overwritten.');
                    }
