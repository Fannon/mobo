...
exports.modelSchemaAdditions = {
    ...
    'properties': {
        ...
        'smw_prefix': {
            'type': ['object', 'string'],
            'description': 'Prefixes wikitext to both forms and templates. Can auto-generate headers, inject templates or add arbitrary wikitext.',
            'properties': {
                'wikitext': {
                    'type': 'string',
        ...
        'smw_prefixForm': {
            'type': ['object', 'string'],
            'description': 'Prefixes wikitext only to forms (edit-view). Can auto-generate headers, inject templates or add arbitrary wikitext.',
            'properties': {
                'wikitext': {
                    'type': 'string',
                    'description': 'wikitext to prefix',
        ...
        'smw_prefixPage': {
            'type': ['object', 'string'],
            'description': 'Prefixes wikitext only to templates (page-view). Can auto-generate headers, inject templates or add arbitrary wikitext.',
            'properties': {
                'wikitext': {
                    'type': 'string',
                    'description': 'wikitext to prefix',
        ...
        'smw_postfixForm': {
            'type': ['object', 'string'],
            'description': 'Postfixes wikitext only to forms (edit-view). Can auto-generate headers, inject templates or add arbitrary wikitext.',
            'properties': {
                'wikitext': {
                    'type': 'string',
                    'description': 'wikitext to prefix',
        ...
        'smw_postfixPage': {
            'type': ['object', 'string'],
            'description': 'Postfixes wikitext only to templates (page-view). Can auto-generate headers, inject templates or add arbitrary wikitext.',
            'properties': {
                'wikitext': {
                    'type': 'string',
                    'description': 'wikitext to prefix',
