...
module.exports = function(settings, callback) {
    ...
    if (uploadCounter > 0) {
        ...
        var report = generateReport(settings, {
            ...
            description: 'mobo bot report. This reports all uploaded, changed and deleted sites together with the logfile and currently used settings.',
            removed: removed,
            changed: changed,
            added: added
        });
