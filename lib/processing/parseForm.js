...
exports.generateForm = function(settings, obj, name, registry) {
    ...
    for (var modelName in obj.properties) {
        ...
        if (model) {
            ...
            /** Adding Prefixes */
            templatingModel.prefix = moboUtil.prePostFix('smw_prefix', model, registry);
            templatingModel.prefix += moboUtil.prePostFix('smw_prefixForm', model, registry);

            /** Adding Postfixes */
            templatingModel.postfix = moboUtil.prePostFix('smw_postfix', model, registry);
            templatingModel.postfix += moboUtil.prePostFix('smw_postfixForm', model, registry);
