...
exports.exec = function(settings, registry) {
    ...
    return new Promise(function (resolve) {
        ...
        log('-------------------------------------------------------------------------');
        log(' ' + _.size(exports.nodes) + ' Nodes | ' + _.size(exports.edges) + ' Edges');
        log('-------------------------------------------------------------------------');
                ...
                if (anyArray) {
                    ...
                    for (var i = 0; i < anyArray.length; i++) {
                        ...
                        if (!exports.edges[edgeId.toLowerCase()]) {
                            ...
                            if (field.items) {
                                exports.edges[edgeId.toLowerCase()].weight = exports.settings.buildGraphSettings.multipleEdgeWeight;
                            }
...
exports.validate = function(nodes, edges) {
    ...
    for (var nodeName in nodes) {
        ...
        var node = nodes[nodeName.toLowerCase()];
