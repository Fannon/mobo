...
exports.generateTemplate = function(model, name, registry, settings) {
    ...
    if (model.smw_prefix) {
        ...
        if (model.smw_prefix.hasOwnProperty('showPage') && model.smw_prefix.showPage === false) {
            data.prefix = false;
            ...
            if (model.smw_prefix.header) {
                ...
                data.prefix += headerLevel + data.title + headerLevel + '\n';
            }

            // Inject wikitext
            if (model.smw_prefix.wikitext ) {
                data.prefix += model.smw_prefix.wikitext;
            }
        }
    }
    ...
    if (model.smw_postfix) {
        ...
        if (model.smw_postfix.hasOwnProperty('showPage') && model.smw_postfix.showPage === false) {
            data.postfix = false;
        } else if (model.smw_postfix.wikitext) {
            data.postfix = model.smw_postfix.wikitext;
        }
    }
