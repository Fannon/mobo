...
exports.exec = function(settings, obj, name, registry) {
    ...
    // Generate Category
    var categoryWikitext = exports.generateCategory(obj, name, registry, settings);
    if (categoryWikitext) {
        returnObject.category[name] = categoryWikitext;
    }

    // Generate Template
    var templateWikitext = exports.generateTemplate(obj, name, registry, settings);
    if (templateWikitext) {
...
exports.generateTemplate = function(model, name, registry, settings) {
    ...
    var data = {
        ...
        templatedata: exports.generateTemplateData(model),
        category: name,
    ...
    data.prefix = moboUtil.prefixModel('showPage', model, registry);
    data.postfix = moboUtil.postfixModel('showPage', model, registry);
 ...
 */
exports.generateTemplateData = function(model) {
