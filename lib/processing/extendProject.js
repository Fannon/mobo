...
exports.exec = function(settings, registry) {
    ...
    return new Promise(function (resolve) {
        ...
        exports.existenceIndex = {}; // Reset existenceIndex
...
exports.inherit = function(obj, registry) {
    ...
    if (obj.properties) {
        for (var attrName in obj.properties) {
            ...
            var attr = obj.properties[attrName];
            exports.inherit(attr, registry);

            // TODO: Rename all property keys to the id they have been given
            // TODO: Currently broken / untested
            //var id = obj.id || obj.items.id || false;
            //if (id !== attrName) {
            //    console.log();
            //    console.log(attrName + ' !== ' + id);
            //
            //    // http://stackoverflow.com/a/14592469/776425
...
exports.extend = function(obj, $extend, registry) {
    ...
    if (obj.$extend || $extend) {
        ...
        var fileName = refArray[refArray.length - 1];
