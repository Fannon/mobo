...
exports.calculateStatistics = function(registry) {
    ...
    registry.statistics.inputStats = {
    ...
    registry.statistics.complexity = {
    ...
    registry.statistics.complexity.processedModelPercentage = Math.round((registry.statistics.complexity.processedModelSize / registry.statistics.complexity.devModelSize) * 100);
    registry.statistics.complexity.generatedPercentage = Math.round((registry.statistics.complexity.generatedSize / registry.statistics.complexity.devModelSize) * 100);
    ...
    // INPUT STATISTICS
    log(' IN:   ' +
        registry.statistics.inputStats.field + ' Fields, ' +
        registry.statistics.inputStats.model + ' Models, ' +
        registry.statistics.inputStats.form + ' Forms,| ' +
        registry.statistics.inputStats.smw_template + ' Templates, ' +
        registry.statistics.inputStats.smw_query + ' Queries, ' +
        registry.statistics.inputStats.smw_page + ' Pages');
    log('------------------------------------------------------------------------------');

    // OUTPUT STATISTICS
    log(' OUT:  ' + registry.statistics.outputStats.property + ' Properties, ' +
        registry.statistics.outputStats.template + ' Templates, ' +
        registry.statistics.outputStats.form + ' Forms, ' +
        registry.statistics.outputStats.category + ' Categories, ' +
        registry.statistics.outputStats.page + ' Pages');
    log('------------------------------------------------------------------------------');

    // COMPLEXITY STATISTICS
    log(' COMP: ' +
        moboUtil.thousandSeparator(registry.statistics.complexity.devModelSize) + ' DevModel, ' +
        moboUtil.thousandSeparator(registry.statistics.complexity.processedModelSize) + ' (' +
        registry.statistics.complexity.processedModelPercentage + '%) ProcModel, ' +
        moboUtil.thousandSeparator(registry.statistics.complexity.generatedSize) + ' (' +
        registry.statistics.complexity.generatedPercentage + '%) Final');
    log('------------------------------------------------------------------------------');
