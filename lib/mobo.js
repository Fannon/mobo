...
exports.exec = function(settings, onGenerated, callback) {
    ...
    moboTaskQueue.then(function(registry) {
        ...
        log(' [E] Error while validating the model.');
        log(e);
    });
    ...
    moboTaskQueue.then(function(registry) {
        ...
        return uploadExportFiles.exec(settings, registry, function(err, lastUploadState) {
            ...
            // TODO: Refactor this: Fake promise, to keep the thens going.
            // TODO: This seems not to be working
            return new Promise(function (resolve, reject) {
                if (err) {
                    reject(err);
                } else {
                    resolve(lastUploadState);
                }
            });
