...
var compatibilityLayer     = require('./processing/compatibilityLayer.js');
...
exports.exec = function(settings, onGenerated, callback) {
    ...
    q.then(function(registry) {
        ...
        // Compatibility Layer
        registry = compatibilityLayer.exec(registry);

        // 2) EXTEND PROJECT TO EXPANDED REGISTRY (applies inheritance)
