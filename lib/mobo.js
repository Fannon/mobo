    ...
    q.then(function(registry) {
        ...
        return uploadExportFiles.exec(settings, registry, function(err) {
            ...
            statistics.printStatistics(' TIME:  ', {
                'Reading': registry.statistics.benchmark.readProject + 'ms',
                'Generation': registry.statistics.benchmark.writeExportFiles + 'ms',
                'Upload / Total': registry.statistics.benchmark.uploadExportFiles + 'ms'
            });
