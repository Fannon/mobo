...
exports.exec = function(settings, onGenerated, callback) {
    ...
    moboTaskQueue.then(function(registry) {
        ...
        if (callback) {
            return callback(false, registry.generated);
        }

        if (settings.writeExportFiles) {
            log(' [D] [6] WRITE EXPORT FILES');
            writeExportFiles.exec(registry.generated, settings.processedModelDir + '/wikitext/', 'wikitext');
    ...
    moboTaskQueue.lastly(function(err) {
